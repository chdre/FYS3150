...
int main(int argc, char *argv[]) {
  ...
  if (argc <= 1) {
    cout << "Missing arguments:" << argv[0]
         << " specify output filename and value of n" << endl;
    exit(1);
  } else {
  ...
  // Dynamic arrays forming the tridiagonal matrix. The upper and lower diagonal
  // are n+1 long
  ...
  double *bt =
      new double[n + 2]; // b tilde, diagonal elements (NOT RHS of equation)
