...
%
\begin{figure}[H]
\subfloat[At this matrix size $n = 80$ and interval size $\rho_{n} = 5$ the number of points per interval results in an acceptable resolution.]{{\includegraphics[scale=0.37]{Resolution1_15.pfd}}}
\qquad
\subfloat[Increasing the interval $\rho_{n} = 20$ while letting our matrix size stay the same significantly lowers the resolution of the plot because the number of points per interval decreases.]{{\includegraphics[scale=0.37]{Resolution2_15.png}}}\qquad
