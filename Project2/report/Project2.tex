...
\end{equation*}
%
To transform the equation to a form such that it can be solved as an eigenvalue problem $\alpha$ is fixed such that
%
\begin{equation*}
...
\begin{figure}[t]
\mbox{\epsfig{figure=iterationspersize.pdf,width=\linewidth,clip=}}
...
\begin{figure}[t]
\mbox{\epsfig{figure=GSEperOMGr.pdf,width=\linewidth,clip=}}
\caption{}
\label{fig:fig2}
\end{figure}
...
\begin{figure}[t]
\mbox{\epsfig{figure=ProbfuncperRhon.pdf,width=\linewidth,clip=}}
\caption{Logarithmic plot of }
\label{fig:fig3}
\end{figure}
