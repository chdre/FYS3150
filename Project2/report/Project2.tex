...
\caption{Plot of different probability distribution of two electrons in a harmonic oscillator potential, with and without Coulomb interaction, for different $\omega_{r}$, as function of our approximation of infinity $\rho_{n}$}
\label{fig:fig3}
\end{figure}
