...
\tablecomments{Analytical energy eigenvalues given in by the paper by M. H. Jensen\cite{2} and the numerical ones calculated by Jacobi's method for $n=400$.}
\tablecolumns{4}
\tablehead{& Analytical  & Numerical }
\startdata
& 3 & 2.99995 \\
& 7 & 6.99976 \\
& 11 & 10.9996 \\
...
\tablecomments{Table comparing the ground state analytic energy eigenvalues as provided in M. Taut's paper\cite{3} and the numerical energy eigenvalues found by Jacobi's method. The analytic eigenvalues displayed in the table of provided by M. Taut are halved.}
\tablecolumns{4}
